...
module.exports = function (route) {
	...
	if (hive.config().has('base_route')) {
		hive_root_route = hive.get_config('base_route');
	} else if (frame.config().has('base_route')) {
		frame_root_route = frame.get_config('base_route');
	} else if (apiary.config().has('base_route')) {
		apiary_root_route = apiary.get_config('base_route');
	}
